...
<?php if($msg = $this->session->flashdata('msg')):?>
  <?php echo $msg; ?>
<?php endif;?>
<?php echo anchor('welcome/add', 'Add New Product', ['class'=>'btn btn-secondary']);?>
<?php echo anchor('welcome/create', 'View All Products', ['class'=>'btn btn-primary']);?>
<?php echo anchor('welcome/create', 'View Reports', ['class'=>'btn btn-info']);?>
<br/>
<br/>
